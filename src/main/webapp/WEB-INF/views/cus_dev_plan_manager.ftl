...
<table id="dg" title="开发计划项" style="width:700px;height:250px"
    ...
    <tr>
        ...
        <th field="planDate" name="planDateStr" width="100"   editor="{type:'datebox',options:{required:true,editable:false}}">日期</th>
        <th field="planItem" width="70" editor="{type:'validatebox',options:{required:true}}">计划内容</th>
        <th field="exeAffect" width="70" editor="{type:'validatebox',options:{required:true}}">执行效果</th>
    </tr>
    </thead>
</table>
